...
Elm.Util.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var removeAt = F2(function (idx,list) {
      return A2($List.map,
      $Basics.snd,
      A2($List.filter,
      function (_p0) {
         var _p1 = _p0;
         return !_U.eq(_p1._0,idx);
      },
      A2($List.indexedMap,F2(function (v0,v1) {    return {ctor: "_Tuple2",_0: v0,_1: v1};}),list)));
   });
   var insertAt = F3(function (item,idx,list) {
      var _p2 = {ctor: "_Tuple2",_0: idx,_1: list};
      _v1_0: do {
         if (_p2._1.ctor === "[]") {
               if (_p2._0 === 0) {
                     break _v1_0;
               ...
               if (_p2._0 === 0) {
                     ...
                     return A2($Maybe.map,function (ys) {    return A2($List._op["::"],_p2._1._0,ys);},A3(insertAt,item,_p2._0 - 1,_p2._1._1));
                  }
            }
      } while (false);
      return $Maybe.Just(A2($List._op["::"],item,_p2._1));
   });
   return _elm.Util.values = {_op: _op,insertAt: insertAt,removeAt: removeAt};
};
Elm.Model = Elm.Model || {};
Elm.Model.make = function (_elm) {
   ...
   var _op = {};
   var dedupify = function (list) {
      return $Basics.snd(A3($List.foldl,
      F2(function (colName,_p0) {
         var _p1 = _p0;
         var _p2 = _p1._0;
         var newCounter = function (c) {    return c + 1;}(A2($Maybe.withDefault,0,A2($Dict.get,colName,_p2)));
         var newCounters = A3($Dict.insert,colName,newCounter,_p2);
         var newColName = _U.eq(newCounter,1) ? colName : A2($Basics._op["++"],colName,$Basics.toString(newCounter - 1));
         return {ctor: "_Tuple2",_0: newCounters,_1: A2($Basics._op["++"],_p1._1,_U.list([newColName]))};
      }),
      {ctor: "_Tuple2",_0: $Dict.empty,_1: _U.list([])},
      list));
   };
   var findCol = F2(function (colName,mapping) {    return A2($List$Extra.find,function (_p3) {    var _p4 = _p3;return _U.eq(_p4._0,colName);},mapping);});
   var colExists = F2(function (theName,mapping) {    return A2($List.any,function (_p5) {    var _p6 = _p5;return _U.eq(_p6._0,theName);},mapping);});
   var IndexOutOfRange = function (a) {    return {ctor: "IndexOutOfRange",_0: a};};
   var ExprTypeError = function (a) {    return {ctor: "ExprTypeError",_0: a};};
   var ColumnAlreadyExists = function (a) {    return {ctor: "ColumnAlreadyExists",_0: a};};
   var NonexistentColumnStep = function (a) {    return {ctor: "NonexistentColumnStep",_0: a};};
   var ApplyFunction = F3(function (a,b,c) {    return {ctor: "ApplyFunction",_0: a,_1: b,_2: c};});
   var MoveColumnToPosition = F2(function (a,b) {    return {ctor: "MoveColumnToPosition",_0: a,_1: b};});
   var RenameColumn = F2(function (a,b) {    return {ctor: "RenameColumn",_0: a,_1: b};});
   var shmooshSteps = F2(function (step1,step2) {
      var _p7 = {ctor: "_Tuple2",_0: step1,_1: step2};
      _v3_2: do {
         if (_p7.ctor === "_Tuple2") {
               switch (_p7._0.ctor)
               {case "MoveColumnToPosition": if (_p7._1.ctor === "MoveColumnToPosition") {
                          var _p8 = _p7._0._0;
                          return _U.eq(_p8,_p7._1._0) ? $Maybe.Just(A2(MoveColumnToPosition,_p8,_p7._1._1)) : $Maybe.Nothing;
                       } else {
                          break _v3_2;
                       }
                  case "RenameColumn": if (_p7._1.ctor === "RenameColumn") {
                          return _U.eq(_p7._0._1,_p7._1._0) ? $Maybe.Just(A2(RenameColumn,_p7._0._0,_p7._1._1)) : $Maybe.Nothing;
                       } else {
                          break _v3_2;
                       }
                  default: break _v3_2;}
   ...
   var smooshScript = function (script) {
      var hasEffect = function (step) {    var _p9 = step;if (_p9.ctor === "RenameColumn") {    return !_U.eq(_p9._0,_p9._1);} else {    return true;}};
      var smooshPairs = function (list) {
         var _p10 = list;
         if (_p10.ctor === "::" && _p10._1.ctor === "::") {
               var _p14 = _p10._1._1;
               var _p13 = _p10._1._0;
               var _p12 = _p10._0;
               var _p11 = A2(shmooshSteps,_p12,_p13);
               if (_p11.ctor === "Just") {
                     return smooshScript(A2($List._op["::"],_p11._0,_p14));
                  } else {
                     return A2($List._op["::"],_p12,smooshScript(A2($List._op["::"],_p13,_p14)));
                  }
            } else {
               return script;
            }
      };
      return A2($List.filter,hasEffect,smooshPairs(script));
   };
   var DropColumn = function (a) {    return {ctor: "DropColumn",_0: a};};
   var SoqlLine = {ctor: "SoqlLine"};
   var SoqlPolygon = {ctor: "SoqlPolygon"};
   var SoqlPoint = {ctor: "SoqlPoint"};
   var SoqlLocation = {ctor: "SoqlLocation"};
   var SoqlText = {ctor: "SoqlText"};
   var SoqlNumber = {ctor: "SoqlNumber"};
   var SoqlMoney = {ctor: "SoqlMoney"};
   var SoqlFloatingTimestamp = {ctor: "SoqlFloatingTimestamp"};
   var SoqlDouble = {ctor: "SoqlDouble"};
   var SoqlCheckbox = {ctor: "SoqlCheckbox"};
   var getOks = function (results) {
      var go = F3(function (soFarErr,soFarOk,remaining) {
         go: while (true) {
            var _p15 = results;
            if (_p15.ctor === "[]") {
                  var _p16 = {ctor: "_Tuple2",_0: soFarErr,_1: soFarOk};
                  if (_p16._0.ctor === "[]") {
                        return $Result.Ok(_p16._1);
                     } else {
                        return $Result.Err(_p16._0);
                     }
               } else {
                  if (_p15._0.ctor === "Ok") {
                        var _v9 = soFarErr,_v10 = A2($List._op["::"],_p15._0._0,soFarOk),_v11 = _p15._1;
                        soFarErr = _v9;
                        soFarOk = _v10;
                        remaining = _v11;
                        continue go;
                     } else {
                        var _v12 = A2($List._op["::"],_p15._0._0,soFarErr),_v13 = soFarOk,_v14 = _p15._1;
                        soFarErr = _v12;
                        soFarOk = _v13;
                        remaining = _v14;
                        continue go;
      ...
      return A3(go,_U.list([]),_U.list([]),results);
   };
   var argsMatch = F2(function (expectedArgs,givenArgs) {
      var _p17 = expectedArgs;
      if (_p17.ctor === "VarArgs") {
            return A2($List.all,function (argTy) {    return _U.eq(argTy,_p17._0);},givenArgs);
         } else {
            return _U.eq(A2($List.map,$Basics.snd,_p17._0),givenArgs);
         }
   });
   var Env = F2(function (a,b) {    return {functions: a,columns: b};});
   var MultipleErrors = function (a) {    return {ctor: "MultipleErrors",_0: a};};
   var NonexistentColumn = function (a) {    return {ctor: "NonexistentColumn",_0: a};};
   var NonexistentFunction = function (a) {    return {ctor: "NonexistentFunction",_0: a};};
   var WrongArgs = function (a) {    return {ctor: "WrongArgs",_0: a};};
   var exprType = F2(function (env,expr) {
      var _p18 = expr;
      switch (_p18.ctor)
      {case "SourceColumn": var _p19 = _p18._0;
           return A2($List.member,_p19,env.columns) ? $Result.Ok(SoqlText) : $Result.Err(NonexistentColumn(_p19));
         case "FunApp": var _p24 = _p18._0;
           var _p20 = A2($Dict.get,_p24,env.functions);
           if (_p20.ctor === "Just") {
                 var _p23 = _p20._0;
                 var argTypeResults = A2($List.map,exprType(env),_p18._1);
                 var _p21 = getOks(argTypeResults);
                 if (_p21.ctor === "Ok") {
                       var _p22 = _p21._0;
                       return A2(argsMatch,_p23.$arguments,_p22) ? $Result.Err(WrongArgs({given: _p22
                                                                                         ,expected: _p23.$arguments})) : $Result.Ok(_p23.returnType);
                    } else {
                       return $Result.Err(MultipleErrors(_p21._0));
                    }
              } else {
                 return $Result.Err(NonexistentFunction(_p24));
              }
         case "StringLit": return $Result.Ok(SoqlText);
         case "DoubleLit": return $Result.Ok(SoqlDouble);
         default: return $Result.Ok(SoqlNumber);}
   });
   var schemaType = F2(function (mapping,env) {
      return A2($Result.formatError,
      MultipleErrors,
      A2($Result.map,
      function (types) {
         return A3($List.map2,F2(function (v0,v1) {    return {ctor: "_Tuple2",_0: v0,_1: v1};}),A2($List.map,$Basics.fst,mapping),types);
      },
      getOks(A2($List.map,function (_p25) {    return A2(exprType,env,$Basics.snd(_p25));},mapping))));
   });
   var NormalArgs = function (a) {    return {ctor: "NormalArgs",_0: a};};
   var VarArgs = function (a) {    return {ctor: "VarArgs",_0: a};};
   var envFunctions = $Dict.fromList(_U.list([{ctor: "_Tuple2",_0: "concat",_1: {$arguments: VarArgs(SoqlText),returnType: SoqlText}}
                                             ,{ctor: "_Tuple2"
                                              ,_0: "parseInt"
                                              ,_1: {$arguments: NormalArgs(_U.list([{ctor: "_Tuple2",_0: "input",_1: SoqlText}])),returnType: SoqlNumber}}
                                             ,{ctor: "_Tuple2"
                                              ,_0: "parseFloatingTimestamp"
                                              ,_1: {$arguments: NormalArgs(_U.list([{ctor: "_Tuple2",_0: "input",_1: SoqlText}
                                                                                   ,{ctor: "_Tuple2",_0: "format",_1: SoqlText}]))
                                                   ,returnType: SoqlFloatingTimestamp}}]));
   var makeEnv = function (columns) {    return {functions: envFunctions,columns: dedupify(columns)};};
   var Function = F2(function (a,b) {    return {$arguments: a,returnType: b};});
   var DoubleLit = function (a) {    return {ctor: "DoubleLit",_0: a};};
   var NumberLit = function (a) {    return {ctor: "NumberLit",_0: a};};
   var StringLit = function (a) {    return {ctor: "StringLit",_0: a};};
   var FunApp = F2(function (a,b) {    return {ctor: "FunApp",_0: a,_1: b};});
   var applyStep = F3(function (step,env,mapping) {
      var _p26 = step;
      switch (_p26.ctor)
      {case "DropColumn": var _p29 = _p26._0;
           return A2(colExists,_p29,mapping) ? $Result.Ok(A2($List.filter,
           function (_p27) {
              var _p28 = _p27;
              return !_U.eq(_p28._0,_p29);
           },
           mapping)) : $Result.Err(NonexistentColumnStep(_p29));
         case "RenameColumn": var _p35 = _p26._1;
           var _p34 = _p26._0;
           return A2(colExists,_p34,mapping) ? A2(colExists,_p35,mapping) ? $Result.Err(ColumnAlreadyExists(_p35)) : $Result.Ok(A2($List.map,
           function (_p30) {
              var _p31 = _p30;
              var _p33 = _p31._0;
              var _p32 = _p31._1;
              return _U.eq(_p33,_p34) ? {ctor: "_Tuple2",_0: _p35,_1: _p32} : {ctor: "_Tuple2",_0: _p33,_1: _p32};
           },
           mapping)) : $Result.Err(NonexistentColumnStep(_p34));
         case "MoveColumnToPosition": var _p40 = _p26._1;
           var _p39 = _p26._0;
           var _p36 = A2(findCol,_p39,mapping);
           if (_p36.ctor === "Just") {
                 return A2($Result.fromMaybe,
                 IndexOutOfRange(_p40),
                 A3($Util.insertAt,_p36._0,_p40,A2($List.filter,function (_p37) {    var _p38 = _p37;return !_U.eq(_p38._0,_p39);},mapping)));
              } else {
                 return $Result.Err(NonexistentColumnStep(_p39));
              }
         default: var newExpr = A2(FunApp,_p26._1,_p26._2);
           var _p41 = A2(exprType,env,newExpr);
           if (_p41.ctor === "Ok") {
                 return $Result.Ok(A2($List._op["::"],{ctor: "_Tuple2",_0: _p26._0,_1: newExpr},mapping));
              } else {
                 return $Result.Err(ExprTypeError(_p41._0));
              }}
   });
   var SourceColumn = function (a) {    return {ctor: "SourceColumn",_0: a};};
   var stepsToMapping = F2(function (script,env) {
      var initialMapping = A2($List.map,function (name) {    return {ctor: "_Tuple2",_0: name,_1: SourceColumn(name)};},env.columns);
      return A3($List.foldl,
      F2(function (step,_p42) {
         var _p43 = _p42;
         var _p46 = _p43._1;
         var _p45 = _p43._0;
         var _p44 = A3(applyStep,step,env,_p46);
         if (_p44.ctor === "Ok") {
               return {ctor: "_Tuple2",_0: A2($Basics._op["++"],_p45,_U.list([$Maybe.Nothing])),_1: _p44._0};
            } else {
               return {ctor: "_Tuple2",_0: A2($Basics._op["++"],_p45,_U.list([$Maybe.Just(_p44._0)])),_1: _p46};
            }
      }),
      {ctor: "_Tuple2",_0: _U.list([]),_1: initialMapping},
      script);
   });
   return _elm.Model.values = {_op: _op
                              ...
                              ,argsMatch: argsMatch
                              ,getOks: getOks
                              ,SoqlCheckbox: SoqlCheckbox
                              ,SoqlDouble: SoqlDouble
                              ,SoqlFloatingTimestamp: SoqlFloatingTimestamp
                              ,SoqlMoney: SoqlMoney
                              ,SoqlNumber: SoqlNumber
                              ,SoqlText: SoqlText
                              ,SoqlLocation: SoqlLocation
                              ,SoqlPoint: SoqlPoint
                              ...
                              ,NonexistentColumnStep: NonexistentColumnStep
                              ,ColumnAlreadyExists: ColumnAlreadyExists
                              ,ExprTypeError: ExprTypeError
                              ,IndexOutOfRange: IndexOutOfRange
                              ,colExists: colExists
                              ,findCol: findCol
                              ,applyStep: applyStep
                              ,dedupify: dedupify
                              ,smooshScript: smooshScript
                              ,shmooshSteps: shmooshSteps
                              ,stepsToMapping: stepsToMapping};
};
Elm.Main = Elm.Main || {};
Elm.Main.make = function (_elm) {
   ...
   var update = F2(function (action,model) {
      var _p0 = action;
      if (_p0.ctor === "AddStep") {
            return _U.update(model,{transformScript: $Model.smooshScript(A2($Basics._op["++"],model.transformScript,_U.list([_p0._0])))});
         } else {
            return _U.update(model,{transformScript: $Model.smooshScript(A2($Util.removeAt,_p0._0,model.transformScript))});
         }
   });
   var initModel = {transformScript: _U.list([])};
   var env = $Model.makeEnv(A2($String.split,
   ",",
   "ID,ID,Case Number,Date,Block,IUCR,Primary Type,Description,Location Description,Arrest,Domestic,Beat,District,Ward,Community Area,FBI Code,X Coordinate,Y Coordinate,Year,Updated On,Latitude,Longitude,Location"));
   var RemoveStep = function (a) {    return {ctor: "RemoveStep",_0: a};};
   var viewScript = F2(function (addr,scriptWithErrors) {
      var closeButton = function (idx) {    return A2($Html.button,_U.list([A2($Html$Events.onClick,addr,RemoveStep(idx))]),_U.list([$Html.text("x")]));};
      var viewStep = F2(function (idx,_p1) {
         var _p2 = _p1;
         var _p4 = _p2._0;
         var _p3 = _p2._1;
         if (_p3.ctor === "Just") {
               return A2($Html.li,
               _U.list([]),
               _U.list([closeButton(idx)
                       ,$Html.text(" ")
                       ,A2($Html.span,_U.list([]),_U.list([$Html.text($Basics.toString(_p4))]))
                       ,$Html.text(" ")
                       ,A2($Html.span,
                       _U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "color",_1: "red"}]))]),
                       _U.list([$Html.text($Basics.toString(_p3._0))]))]));
            } else {
               return A2($Html.li,_U.list([]),_U.list([closeButton(idx),$Html.text(" "),$Html.text($Basics.toString(_p4))]));
            }
      });
      return A2($Html.ul,_U.list([]),A2($List.indexedMap,viewStep,scriptWithErrors));
   });
   var AddStep = function (a) {    return {ctor: "AddStep",_0: a};};
   var viewColumn = F4(function (addr,idx,length,_p5) {
      var _p6 = _p5;
      var _p7 = _p6._0;
      return A2($Html.span,
      _U.list([]),
      _U.list([A2($Html.button,_U.list([A2($Html$Events.onClick,addr,AddStep($Model.DropColumn(_p7)))]),_U.list([$Html.text("x")]))
              ,A2($Html.button,
              _U.list([A2($Html$Events.onClick,addr,AddStep(A2($Model.MoveColumnToPosition,_p7,idx - 1))),$Html$Attributes.disabled(_U.eq(idx,0))]),
              _U.list([$Html.text("^")]))
              ,A2($Html.button,
              _U.list([A2($Html$Events.onClick,addr,AddStep(A2($Model.MoveColumnToPosition,_p7,idx + 1))),$Html$Attributes.disabled(_U.eq(idx,length - 1))]),
              _U.list([$Html.text("v")]))
              ,$Html.text(" ")
              ,A2($Html.input,
              _U.list([$Html$Attributes.value(_p7)
                      ,$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "font-weight",_1: "bold"}]))
                      ,A2($Html$Events$Extra.onInput,addr,function (newName) {    return AddStep(A2($Model.RenameColumn,_p7,newName));})
                      ,$Html$Attributes.size(20)]),
              _U.list([]))
              ,$Html.text(" ")
              ,$Html.text($Basics.toString(_p6._1))
              ,$Html.text(": ")
              ,A2($Html.span,
              _U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "font-style",_1: "italic"}]))]),
              _U.list([$Html.text($Basics.toString(_p6._2))]))]));
   });
   var viewColumns = F2(function (addr,schema) {
      var numCols = $List.length(schema);
      return A2($Html.ul,
      _U.list([]),
      A2($List.indexedMap,
      F2(function (idx,_p8) {
         var _p9 = _p8;
         var _p10 = _p9._1;
         return A2($Html.li,_U.list([]),_U.list([A4(viewColumn,addr,idx,numCols,{ctor: "_Tuple3",_0: _p9._0,_1: _p10,_2: A2($Model.exprType,env,_p10)})]));
      }),
      schema));
   });
   var view = F2(function (addr,model) {
      var _p11 = A2($Model.stepsToMapping,model.transformScript,env);
      var stepErrors = _p11._0;
      var mapping = _p11._1;
      return A2($Html.table,
      _U.list([]),
      _U.list([A2($Html.tr,
              _U.list([]),
              _U.list([A2($Html.td,_U.list([]),_U.list([A2($Html.h1,_U.list([]),_U.list([$Html.text("Columns")]))]))
                      ,A2($Html.td,_U.list([]),_U.list([A2($Html.h1,_U.list([]),_U.list([$Html.text("Transform Script")]))]))]))
              ,A2($Html.tr,
              _U.list([]),
              _U.list([A2($Html.td,
                      _U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "vertical-align",_1: "top"}]))]),
                      _U.list([A2(viewColumns,addr,mapping)]))
                      ,A2($Html.td,
                      _U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "vertical-align",_1: "top"}]))]),
                      _U.list([A2(viewScript,
                      addr,
                      A3($List.map2,F2(function (v0,v1) {    return {ctor: "_Tuple2",_0: v0,_1: v1};}),model.transformScript,stepErrors))]))]))]));
   });
   var main = $StartApp$Simple.start({model: initModel,view: view,update: update});
   var Model = function (a) {    return {transformScript: a};};
